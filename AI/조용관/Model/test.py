...
if __name__ == "__main__":
    ...
    #checkpoint_path = f"/content/drive/MyDrive/Colab Notebooks"
    #save_ckpt_path = f"{checkpoint_path}/my_model_mark3.pth"
    ...
    model = torch.load('/content/drive/MyDrive/Colab Notebooks/my_model_mark3.pth')
