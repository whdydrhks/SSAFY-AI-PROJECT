        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
               Text(
                "감정",
                style: TextStyle(fontSize: 24, fontFamily: 'Jua_Regular', color:  currentMode == ThemeMode.dark ? Colors.white : Palette.blackTextColor),
              ),
              const SizedBox(
                height: 16,
              ),
                                  ...
                                  child: ColorFiltered(
                                    colorFilter:
                                        controller.images[index].isSelected!
                                            ...
                                            :  ColorFilter.mode(
                                                currentMode == ThemeMode.dark ? Color(0xff292929): Colors.white,
